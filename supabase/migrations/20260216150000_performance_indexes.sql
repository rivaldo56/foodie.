...
CREATE INDEX IF NOT EXISTS idx_experiences_featured_status
...
CREATE INDEX IF NOT EXISTS idx_menus_status_exp
...
CREATE INDEX IF NOT EXISTS idx_chefs_id_user_id
ON chefs(id, user_id);
