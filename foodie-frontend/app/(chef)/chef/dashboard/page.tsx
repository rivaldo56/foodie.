  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur h-[500px] overflow-y-auto">
          <h3 className="text-lg font-semibold text-white sticky top-0 bg-[#1a1a1a] pb-4 z-10">Upcoming Bookings</h3>
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <p className="text-sm text-white/60">{booking.service_type.replace('_', ' ')}</p>
      ...
      <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-4">
          <div className="space-y-1">
            ...
            <p className="text-2xl font-semibold text-white">{analytics.bookings.pending}</p>
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-2">
